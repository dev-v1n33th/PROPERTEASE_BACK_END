...
public class AvailableBeds {
	...
	public AvailableBeds(int id, String bedId, int roomId, boolean bedStatus, String guestId, String bedName,
				double defaultRent, boolean ac, double securityDeposit, String createdBy, int floorId, int buildingId,
				Date createdOn) {
			super();
			this.id = id;
			this.bedId = bedId;
